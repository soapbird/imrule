...
|---|---|---|---|---|
| cli-python | `settings.python.json.tmpl` | `extensions.python.json.tmpl` | `launch.python-cli.json.tmpl` | `tasks.python.json.tmpl` |
| server-python | `settings.python.json.tmpl` | `extensions.python.json.tmpl` | `launch.python-server.json.tmpl` | `tasks.python.json.tmpl` |
| cli-rust | `settings.rust.json.tmpl` | `extensions.rust.json.tmpl` | `launch.rust-cli.json.tmpl` | `tasks.rust.json.tmpl` |
| server-rust | `settings.rust.json.tmpl` | `extensions.rust.json.tmpl` | `launch.rust-server.json.tmpl` | `tasks.rust.json.tmpl` |
