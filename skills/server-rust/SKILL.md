...
3. 순서:
   ...
   5. `.env.template`, Makefile(`setup-make` 표준 + `run`·`migrate`), Dockerfile(cargo-chef, `setup-docker`)
...
```markdown
## server-rust 검사: <프로젝트> — 구조 (A) 기능별 모듈 — PASS 19 · WARN 12 · FAIL 2
