...
CARGO    := cargo
BINARY   := target/release/ruler
TEST_DIR := test-e2e
TMP      := /tmp/ruler-e2e

.PHONY: all build check clean fmt fmt-fix install lint run test test-e2e
...
# ── End-to-end tests ──────────────────────────────────────────────
test-e2e: build
	@echo ""; echo "━━━ E2E: ruler init (local) ━━━"
	rm -rf $(TMP)/init-local && mkdir -p $(TMP)/init-local
	$(BINARY) init --project-root $(TMP)/init-local
	@test -d $(TMP)/init-local/.ruler            && echo "[PASS] .ruler directory created"    || (echo "[FAIL] .ruler directory missing"    && exit 1)
	@test -f $(TMP)/init-local/.ruler/ruler.toml  && echo "[PASS] ruler.toml created"         || (echo "[FAIL] ruler.toml missing"          && exit 1)
	@test -f $(TMP)/init-local/.ruler/AGENTS.md   && echo "[PASS] AGENTS.md created"          || (echo "[FAIL] AGENTS.md missing"           && exit 1)
	@echo ""; echo "━━━ E2E: ruler init --global ━━━"
	rm -rf $(TMP)/init-global && mkdir -p $(TMP)/init-global
	XDG_CONFIG_HOME=$(TMP)/init-global $(BINARY) init --global
	@test -d $(TMP)/init-global/ruler             && echo "[PASS] global dir created"         || (echo "[FAIL] global dir missing"          && exit 1)
	@test -f $(TMP)/init-global/ruler/ruler.toml  && echo "[PASS] global ruler.toml created"  || (echo "[FAIL] global ruler.toml missing"   && exit 1)
	@test -f $(TMP)/init-global/ruler/AGENTS.md   && echo "[PASS] global AGENTS.md created"   || (echo "[FAIL] global AGENTS.md missing"    && exit 1)
	@echo ""; echo "━━━ E2E: ruler init (idempotent) ━━━"
	$(BINARY) init --project-root $(TMP)/init-local
	@grep -q "Ruler Configuration File" $(TMP)/init-local/.ruler/ruler.toml && echo "[PASS] init did not overwrite existing files" || (echo "[FAIL] init overwrote existing files" && exit 1)
	@echo ""; echo "━━━ E2E: ruler apply (all agents) ━━━"
	...
	@grep -q "Generated by Ruler" $(TMP)/apply-all/CLAUDE.md              && echo "[PASS] CLAUDE.md has marker"      || (echo "[FAIL] CLAUDE.md missing marker"    && exit 1)
	@grep -q "Source:" $(TMP)/apply-all/CLAUDE.md                         && echo "[PASS] CLAUDE.md has source comment" || (echo "[FAIL] CLAUDE.md missing source"   && exit 1)
	@echo ""; echo "━━━ E2E: ruler apply --dry-run ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler apply --agents claude ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler apply --agents claude,copilot ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler apply --no-mcp ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler apply (MCP merge) ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler apply --mcp-overwrite ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler apply --backup true ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler apply --backup false ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler apply (gitignore) ━━━"
	...
	@grep -q "Ruler Generated Files" $(TMP)/apply-gitignore/.gitignore    && echo "[PASS] .gitignore updated"        || (echo "[FAIL] .gitignore not updated"      && exit 1)
	@echo ""; echo "━━━ E2E: ruler apply --gitignore false ━━━"
	...
	@grep -q "Ruler Generated Files" $(TMP)/apply-nogitignore/.gitignore  && echo "[FAIL] .gitignore updated" && exit 1 || echo "[PASS] .gitignore not updated"
	@echo ""; echo "━━━ E2E: ruler revert (basic) ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler revert --keep-backups ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler revert --dry-run ━━━"
	...
	@echo ""; echo "━━━ E2E: ruler apply --local-only ━━━"
